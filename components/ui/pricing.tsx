        ...
        <div className="bg-slate-50 relative py-24 md:py-32 overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6 relative z-10">
                <div className="mx-auto max-w-2xl text-center mb-16 animate-fade-in-up">
                    <h2 className="text-slate-900 text-3xl font-bold md:text-4xl lg:text-5xl tracking-tight">{t("pricing.title")}</h2>
                    <p className="text-slate-600 mx-auto mt-4 max-w-md text-balance text-lg">{t("pricing.subtitle")}</p>
                </div>
                        ...
                        return (
                            <div 
                                ...
                                className={`relative flex flex-col rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                                    plan.popular ? 'ring-2 ring-sky-500 scale-105 z-10' : 'border border-slate-200'
                                }`}
                            >
                                {plan.popular && (
