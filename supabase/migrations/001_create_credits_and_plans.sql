...
BEGIN
    -- For now, we'll use a default workspace or create one
    -- This assumes you have a workspaces table or similar
    -- You might need to adjust this based on your workspace creation logic
    ...
    INSERT INTO public.user_credits (
        ...
        COALESCE(NEW.raw_user_meta_data->>'workspace_id', gen_random_uuid()), -- Default workspace
        NEW.id,
        'credit',
        100,
        100,
