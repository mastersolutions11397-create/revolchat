      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="relative rounded-3xl bg-slate-900 px-6 py-16 md:py-24 overflow-hidden shadow-2xl">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
            <Badge variant="secondary" className="mb-6 bg-sky-500/10 text-sky-400 hover:bg-sky-500/20 border-sky-500/20 px-4 py-1">
              {t("cta.badge")}
            </Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/auth/signup">
                <Button size="lg" className="bg-sky-500 text-white hover:bg-sky-600 transition-all duration-300 font-bold px-8 h-14 text-lg shadow-lg shadow-sky-500/25 hover:-translate-y-0.5">
                  Get Started Free
                </Button>
              </Link>
              <Link href="/contact">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
              <div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <button className="px-8 py-4 rounded-xl text-white bg-sky-500 hover:bg-sky-600 transition-all shadow-lg shadow-sky-500/25 font-semibold text-lg">
                   Lets Get Started
                  </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-1 md:col-span-2 bg-sky-50 rounded-3xl p-8 md:p-12 relative overflow-hidden group hover:shadow-xl transition-all duration-500 border border-sky-100">
              <div className="relative z-10 max-w-md">
                ...
                <div className="flex items-center gap-2 text-sky-600 font-semibold group-hover:translate-x-2 transition-transform cursor-pointer">
            ...
            {/* Feature 4 - Analytics */}
            <div className="col-span-1 md:col-span-2 bg-gradient-to-br from-sky-500 to-blue-600 rounded-3xl p-8 md:p-12 relative overflow-hidden group hover:shadow-xl transition-all duration-500 text-white">
              <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-8">
                <div className="flex-1">
                  ...
                  <button className="bg-white text-sky-600 px-6 py-3 rounded-xl font-semibold hover:bg-sky-50 transition-colors">
                    View Case Studies
                  </button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 animate-fade-in-up delay-200">
            ...
            <div className="rounded-2xl p-6 text-white bg-[linear-gradient(135deg,#00a8e8,#0088cc)] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col">
              ...
              <div className="relative self-end aspect-square bg-white rounded-full w-[70px] h-[70px] overflow-hidden mt-4 shadow-md">
                <Image src="/yetti/telegram_1.png" alt="Yetti Telegram" fill className="object-contain scale-[0.6]" sizes="(max-width: 768px) 100vw, 33vw" />
              </div>
