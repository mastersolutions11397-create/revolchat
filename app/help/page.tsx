        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pl-12 pr-12 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#5170ff] focus:border-transparent transition-all text-lg"
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl bg-white p-8 shadow-lg border border-gray-200 text-center">
              ...
              <Link
                ...
                className="text-[#5170ff] font-semibold hover:text-[#4a68f0] transition-colors inline-flex items-center gap-2"
              >
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 rounded-lg transition-all flex items-center gap-3 ${
                          selectedCategory === category.id
                            ? "bg-[#5170ff] text-white font-semibold"
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="ml-4">
                        <Link
                          ...
                          className="text-[#5170ff] hover:text-[#4a68f0] font-semibold inline-flex items-center gap-2"
                        >
              ...
              {filteredArticles.length === 0 && (
                <div className="rounded-xl bg-white p-12 shadow-lg border border-gray-200 text-center">
                  ...
                  <button
                    ...
                    className="text-[#5170ff] hover:text-[#4a68f0] font-semibold"
                  >
                    Clear filters
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    href="/contact"
                    className="px-8 py-4 rounded-xl text-white bg-[#5170ff] hover:bg-[#4a68f0] transition-colors shadow-[0_8px_30px_rgba(81,112,255,0.35)] font-semibold text-center"
                  >
                    Contact Support
                  </Link>
                  <Link
