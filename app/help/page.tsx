...
export default function HelpPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gradient-to-tr from-sky-500 to-slate-900">
        {/* Background Effects */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group rounded-2xl bg-white p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <Link
                ...
                className="text-sky-500 font-semibold hover:text-sky-700 transition-colors inline-flex items-center gap-2 group-hover:gap-3"
              >
            ...
            <div className="group rounded-2xl bg-white p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <Link2 className="w-7 h-7 text-sky-500" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">
                Integrations
              </h3>
              ...
              <Link
                ...
                className="text-sky-500 font-semibold hover:text-sky-500 transition-colors inline-flex items-center gap-2 group-hover:gap-3"
              >
                ...
                <div className="space-y-1">
                  {categories.map((category) => {
                    ...
                    return (
                      ...
                      >
                        <IconComponent className={`w-5 h-5 ${isActive ? "text-sky-500" : "text-slate-400"}`} />
                        {category.name}
                      </button>
                    );
                  })}
              ...
              {filteredArticles.length === 0 && (
                <div className="rounded-2xl bg-white p-16 shadow-sm border border-slate-200 text-center">
                  ...
                  <button
                    ...
                    className="text-sky-500 hover:text-sky-700 font-semibold hover:underline"
                  >
                    Clear all filters
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 relative z-10">
              ...
              <div className="text-center lg:text-left lg:order-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Link
                    href="/contact"
                    className="px-8 py-4 rounded-xl text-white bg-sky-500 hover:bg-sky-500 transition-all shadow-lg shadow-sky-500/25 font-bold text-center hover:-translate-y-0.5"
                  >
                    Contact Support
                  </Link>
                  <Link
