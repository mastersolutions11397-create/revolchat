        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-gray-700">
                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-gray-300 bg-white text-[#5170ff] focus:ring-[#5170ff]" />
                Remember me
              </label>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              <button className="w-full inline-flex justify-center items-center gap-2 py-3 px-4 rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
